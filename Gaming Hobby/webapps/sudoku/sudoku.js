...
//solve empty grid locations
//save user entered grid
//attempt solve
//on fail restore grid instead of clear
//re-attempt solve
...
function solve(){
  ...
  gridSave = JSON.parse(JSON.stringify(grid));
